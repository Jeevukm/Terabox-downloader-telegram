async function main() {
  ...
  bot.start(async (ctx) => {
    try {
      ctx.reply(
        `Hi ${ctx.message.from.first_name},\n\nI can Download Files from Terabox❤️.\n\nMade with 🧑‍💻 by @jeevan_shetty\n\nSend any terabox link to download.`,
        Markup.inlineKeyboard([
          Markup.button.url(" Channel", "https://t.me/shetty_Bots"),
          Markup.button.url("Report bug", "https://t.me/shettyDiscus_Group"),
        ]),
      );
    } catch (e) {
      console.error(e);
